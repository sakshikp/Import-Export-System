...
<body>
	...
	<div class="offcanvas offcanvas-start bg-dark text-white" id="sidebar">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="indexSellerProfile.jsp">Profile</a>
          </li>
        </ul>
		</div>
	</div>
	...
	<div class="card bg-dark">
		...
		<form id="loginForm" action="ConsumerController" method="post">
			...
			<div class="mb-3">
				<label for="password" class="form-label">New Password</label> <input
					type="password" class="form-control dark-input" id="password"
					name="password" required />
			</div>
			<div class="mb-3">
				<label for="password" class="form-label">Location</label> <input
					type="text" class="form-control dark-input" id="loaction"
			...
			<div class="d-flex flex-column">
				...
				<a href="deleteConsumerProfile.jsp" class="btn btn-danger w-100">Delete
					Profile</a>
			</div>
