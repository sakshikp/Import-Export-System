...
.light-mode .table-hover tbody tr:hover {
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-black p-3">
        <div class="container-fluid">
          ...
          <form class="d-flex me-3">
            <input class="form-control dark-input me-2" type="search" placeholder="Search" aria-label="Search">
    ...
    <p class="card-text"><strong>Quantity:</strong> <%= product.getQuantity() %></p>
</div>
<button class="btn btn-primary" 
        onclick="addToCart(<%= product.getProductId() %>, '<%= product.getProductName() %>', <%= product.getPrice() %>)">
    Add to Cart
</button>
                    </div>
                </div>
