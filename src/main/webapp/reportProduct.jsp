...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-black p-3">
		<div class="container-fluid">
			...
			<button class="btn btn-outline-light me-3" data-bs-toggle="offcanvas"
	...
	<div class="card bg-dark">
		<div class="d-flex gap-3 justify-content-center align-items-center">
			<h2 class="mb-4 text-center">Report a Product Issue</h2>
		</div>
		<form action="ReportProductController" method="post">
			<div class="mb-3">
				<label for="consumerPortId" class="form-label">Port ID:</label> <input
					type="text" id="consumerPortId" name="consumerPortId"
			...
			<div class="mb-3">
			<label for="issueType" class="form-label">Issue Type:</label> <select
				id="issueType" name="issueType" class="form-select dark-input"
				required>
			...
			<button type="submit" class="btn btn-primary w-100 mt-3">Report</button>
		</form>
	</div>
	<script>
      document
