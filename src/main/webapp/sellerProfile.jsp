...
<html lang="en">
  ...
  <%
    ...
    <form>
        ...
        <input type="text" class="form-control dark-input" id="name" value="<%= seller.getPortId() %>" />
      </div>
      <div class="mb-4">
        <label for="address" class="form-label">Address</label>
        <textarea class="form-control dark-input" id="address" rows="3"><%= seller.getLocation() %></textarea>
      </div>
      <a href="updateSeller.jsp" class="btn btn-primary w-100 mb-2">Edit Profile</a>
      <a href="register.jsp" class="btn btn-danger w-100 mb-2">Logout</a>
    <%
    } else {
    %>
      <p class="text-white text-center">Seller data not found.</p>
    <%
    }
    %>
    </form>
